...
| `mermail-bounty-agent` | Verify bounty leads from email, rank eligible opportunities, prepare execution briefs, and track submissions through payout evidence |
